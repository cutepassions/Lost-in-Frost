...
public class MemberServiceImpl implements MemberService {
    ...
    public Response<?> joinMember(MemberJoinReqDto memberJoinReqDto) {
        ...
        Member nickname = memberRepository.findByNicknameAndIsDeleted(memberJoinReqDto.getNickname(), false).orElse(null);
        if (nickname != null) {
        ...
        if (flag) {
            ...
            MyCostume myCostume = MyCostume.builder().
                    costumeSeq(1L).
                    member(member).
                    costumeGrade("normal").
    ...
    public Response<?> loginMember(MemberLoginReqDto memberLoginReqDto) {
        ...
        Member member = memberRepository.findByEmailAndAuthProviderAndIsDeleted(memberLoginReqDto.getEmail(), null, false).orElse(null);
        boolean flag = false;
        ...
        if (flag) {
            UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(member.getId(), memberLoginReqDto.getPassword());
